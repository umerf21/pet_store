...
const navbarHeight = Platform.OS === 'ios' ? 50 : 56;
...
const bottomSpaceIphoneX = ratio(54);
const bottomPadding = isIphoneX() ? bottomSpaceIphoneX : ratio(30);
const bottomPaddingIphoneX = isIphoneX() ? bottomSpaceIphoneX : 4;
...
export default {
  ...
  bottomPadding,
  baseMargin: ratio(16, 16, true) || 16,
  smallMargin: ratio(8) || 12,
  midMargin: ratio(12) || 12,
  largeMargin: ratio(20),
  app: {
    largeRadius: ratio(16),
    baseRadius: ratio(8),
    smallRadius: ratio(4),
  },
};
